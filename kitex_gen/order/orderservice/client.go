...
type Client interface {
	...
	UpdateStatus(ctx context.Context, req *order.UpdateStatusRequest, callOptions ...callopt.Option) (r *order.UpdateStatusResponse, err error)
}
...
func (p *kOrderServiceClient) UpdateStatus(ctx context.Context, req *order.UpdateStatusRequest, callOptions ...callopt.Option) (r *order.UpdateStatusResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
